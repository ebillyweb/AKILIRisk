...
-- General Discovery
('00000000-0000-0000-0001-000000000001', '1', 'How did your financial advisor describe what we do at {{firmName}}?', 'fillable', NULL, NULL, NULL, NULL, 'An opportunity to describe our services in greater depth.', NULL, FALSE, NULL, 1, TRUE),
('00000000-0000-0000-0001-000000000001', '2', 'Have you talked to your professional advisors about your personal and "family risk"?', 'yes_no', NULL, NULL, NULL, NULL, 'Establishes the client''s baseline sophistication and surfaces a value proposition opportunity.', NULL, FALSE, 'See 1_A.5', 2, TRUE),
('00000000-0000-0000-0001-000000000001', '3', 'How involved are you personally in managing your family''s or business''s risk protection—do you rely mostly on advisors, or do you like to be hands-on?', 'fillable', NULL, NULL, NULL, NULL, 'Establishes the client''s baseline level of involvement and sophistication.', NULL, FALSE, NULL, 3, TRUE),
('00000000-0000-0000-0001-000000000001', '4', 'Do you know where your key risks reside?', 'yes_no', NULL, NULL, NULL, NULL, 'Establishes the client''s awareness of where their key risks lie.', NULL, FALSE, NULL, 4, TRUE),
('00000000-0000-0000-0001-000000000001', '5', 'When you think about risk, what comes to mind first—financial, personal, cyber, or something else?', 'fillable', NULL, NULL, NULL, NULL, 'Helps establish client priorities.', NULL, FALSE, NULL, 5, TRUE),
...
('00000000-0000-0000-0001-000000000003', '15', 'What are the zip codes?', 'fillable', NULL, NULL, NULL, NULL, NULL, NULL, FALSE, NULL, 3, TRUE),
('00000000-0000-0000-0001-000000000003', '16', 'Are any located in coastal or wildfire-prone areas?', 'yes_no', NULL, NULL, NULL, NULL, 'Surfaces geographic exposure in coastal or wildfire-prone areas.', NULL, FALSE, NULL, 4, TRUE),
...
('00000000-0000-0000-0001-000000000003', '19', 'Do you or your family travel frequently, domestically or internationally?', 'yes_no', NULL, NULL, NULL, NULL, NULL, NULL, FALSE, 'See Physical Security', 7, TRUE),
...
('00000000-0000-0000-0002-000000000002', 'B4', 'How are next-generation members trained or mentored for financial stewardship and leadership roles?', 'scored_0_3', 'None', 'Case-by-case', 'Defined', 'Reviewed and tied to development', 'Unprepared heirs increase stewardship and governance risk.', 'Build a structured leadership and education track for heirs.', FALSE, NULL, 5),
...
('00000000-0000-0000-0002-000000000003', 'C3', 'Are family philanthropy and charitable giving formally governed?', 'scored_0_3', 'None', 'Ad hoc', 'Structured', 'Strategic + reviewed', 'Undirected giving reduces impact, creates tax risk, and misaligns values.', 'Formalize a giving policy aligned with family values and tax strategy; include documented mission statements and giving charters.', FALSE, NULL, 4),
('00000000-0000-0000-0002-000000000003', 'C4', 'What structured allowances and accountability reviews apply to younger family members?', 'scored_0_3', 'None', 'Informal', 'Designated', 'Trained + pre-approved', 'Unstructured access undermines financial discipline and development.', 'Deploy Belvedere proprietary financial education and allowance management tools.', FALSE, NULL, 5),
...
('00000000-0000-0000-0002-000000000004', 'D2', 'Is there a designated spokesperson for media, legal, or public matters?', 'scored_0_3', 'None', 'Assumed', 'Designated', 'Trained + pre-approved', 'Lack of a designated spokesperson increases misstatement risk.', 'Appoint and train a single designated spokesperson; connect with a vetted PR network for communications support.', FALSE, NULL, 3),
('00000000-0000-0000-0002-000000000004', 'D3', 'Are confidentiality agreements in place for household staff, advisors, and vendors?', 'scored_0_3', 'None', 'Informal', 'Standard NDAs', 'Comprehensive + enforced', 'Sharing confidential information with staff or vendors without NDAs in place creates significant legal and reputational exposure.', 'Standardize NDA requirements for all staff, vendors, and advisors with legal review.', FALSE, NULL, 4),
...
('00000000-0000-0000-0003-000000000001', 'A7', 'Have you or your family members ever been the victim of phishing or social engineering scams?', 'scored_0_3', 'Frequent/Unresolved', 'Occasional', 'Rare', 'None and training applied', 'Past incidents are strong predictors of future risk. This helps identify recurring patterns and whether lessons were applied—or ignored.', 'Conduct post-incident review and apply lessons to training and controls.', FALSE, NULL, 7),
...
('00000000-0000-0000-0003-000000000006', 'F4', 'Are backup credentials and account recovery information stored securely?', 'scored_0_3', 'Insecure', 'Basic', 'Secure', 'Encrypted and access-controlled', 'Poor storage of recovery credentials undermines all other security controls.', 'Store all recovery codes, backup credentials, and emergency access information in an encrypted vault with controlled access.', FALSE, NULL, 4),
...
('00000000-0000-0000-0005-000000000002', 'B1', 'Do you have copies of all personal insurance policies compiled and organized?', 'scored_0_3', 'None', 'Partial', 'Complete', 'Centralized + digitized', 'Policy review confirms actual coverage terms, exclusions, and limits—summaries alone often omit critical restrictions that affect claim outcomes.', 'Collect declarations pages and endorsements; validate active status and limits; confirm named insured accuracy.', FALSE, NULL, 1),
('00000000-0000-0000-0005-000000000002', 'B2', 'Are your residences insured in a manner consistent with their ownership structure (individual, trust, LLC)?', 'scored_0_3', 'Misaligned', 'Some alignment', 'Mostly aligned', 'Fully aligned + reviewed', 'Incorrectly titled insurance can result in partial or total denial of property or liability claims.', 'Compare property title to policy named insured; correct misalignments with broker and legal counsel.', FALSE, NULL, 2),
