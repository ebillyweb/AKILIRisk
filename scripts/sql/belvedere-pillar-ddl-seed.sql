...
('00000000-0000-0000-0002-000000000001', 'A3c', 'When was the last meeting?', 'date', NULL, NULL, NULL, NULL, 'Long gaps indicate governance drift and latent risk accumulation.', 'Trigger governance reset or facilitated session if lapse exceeds threshold.', TRUE, NULL, 7),
