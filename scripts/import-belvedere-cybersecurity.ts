/**
 * Cybersecurity service recommendations (questions live in pillar DDL — npm run seed:pillar-ddl).
 */
...
async function importCybersecurityQuestions(): Promise<number> {
  throw new Error(
    "Cybersecurity question import to AssessmentBankQuestion was removed. Use npm run seed:pillar-ddl.",
  );
}
