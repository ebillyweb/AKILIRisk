...
import { updateEnterprisePillarNarrative } from "@/lib/actions/enterprise-methodology-actions";
...
export function EnterpriseNarrativeEditor({
  pillarSlug,
  allNegative,
  allYes,
  midBand,
    ...
    <form
      ...
      action={(formData) => {
        startTransition(async () => {
          await updateEnterprisePillarNarrative(pillarSlug, {
