...
import { updateEnterprisePillarOverride } from "@/lib/actions/enterprise-methodology-actions";
...
export function EnterprisePillarManagerForm({ pillars }: { pillars: PillarRow[] }) {
              ...
              <Checkbox
                ...
                onCheckedChange={(checked) => {
                  startTransition(async () => {
                    await updateEnterprisePillarOverride(pillar.slug, {
              ...
              <form
                action={(formData) => {
                  startTransition(async () => {
                    ...
                    await updateEnterprisePillarOverride(pillar.slug, { weight });
                  });
                }}
              >
                <Input
