 ...
 * ("Don't use no-reply"). Those are rewritten to hello@ on the same domain.
 */
...
/**
 * Replace no-reply / noreply local parts with `hello` on the same domain.
