-- Governance document-upload sub-questions for parents whose 3rd/4th tier implies documentation.
...
-- Renumber governance sections so document subs follow their parent.
UPDATE questions q
