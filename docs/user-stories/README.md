...
| **5.4** | Advisor workspace, pipeline & documents (FR-7, §3.4) | US-28 – US-36 | [EPIC-5.4](./EPIC-5.4-advisor-workspace-pipeline.md) — *includes per-advisor ACTIVE/INACTIVE assignment semantics; US-35 here is advisor notifications; 5.6 US-35 is MFA (renumber pending)* |
